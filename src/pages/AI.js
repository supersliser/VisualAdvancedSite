...
const PageTwo = ({ data }) => (
  <Main>
    ...
    <FRR>
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/VSnIYAQUxaI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>      <Text>Read the whole Transcript between LaMDA and the Google Engineers <Link to="https://cajundiscordian.medium.com/is-lamda-sentient-an-interview-ea64d916d917">here.</Link></Text>
    </FRR>
    <Fll>
